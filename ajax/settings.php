...
$_SESSION['last_screen'] = "settings.php";
?>
...
// SELECT COMPANY DETAILS FROM SETTINGS
...
//SELECT STORE NAME
$select = "<select name='store' class='form-control' id='store'><option value='none'>select store</option>";
...
if ($result) {
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            //PUT DEFAULT STORE AS THE SELECTED
            if ($store == $store_id) {
                $select .= "<option selected='selected' id='store' value='$store_id'>$store_name</option>";
            } else {
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-10" id="ftp_servername-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="ftp_servername" name="ftp_servername"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-10" id="sms_username-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="sms_username" name="sms_username" value="<?php echo $sms_username; ?>">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-10" id="ftp_serverpassword-group">
                            <div class="input-group">
                                <input type="password" class="form-control" id="ftp_serverpassword" name="ftp_serverpassword"
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-10" id="ftp_serveruser-group">
                            <div class="input-group">
                                <input type="tel" class="form-control" id="ftp_serveruser" name="ftp_serveruser"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="col-md-10" id="email_pass-group">
                            <div class="input-group">
                                <input type="password" class="form-control" id="email_pass" name="email_pass"
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-md-5" id="finishdate-group">
                            <div class="input-group col-sm-12">
                                <input type="text" name="mydate2" id="finishdate" placeholder="end date" class="form-control" value="<?php echo $end_date; ?>">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
...
//        });
    ...
    $(document).ready(function () {
        ...
        $('#upload').keyup(function () {
            $('.help-block').remove();
            var upload_u =  "<?php if($upload!=""){echo $upload;}?>";
            if (upload_u!=""){
                if($(this).val()!= upload_u){
                    $('#upload-group').append('<div class="help-block" style="color: red">Be careful of changes made here as it can alter certain setting properties</div>');
                }
            }
            ...
            $.ajax({
                ...
                .done(function (data) {
                    if (!data.success) {
                        ...
                        $('#message_div').empty().fadeIn(1000).append('<div class="alert alert-success" ><buttton class="close" data-dismiss="alert"><i class= "fa-fw fa fa-times"></i></buttton><i class = "fa-fw fa fa-times"></i> Update Successful!!!</div>').fadeOut(2000);
                        setTimeout(function () {
                            location.href = '<?php echo APP_URL;?>/index.php#ajax/settings.php';
                            //window.location(true);
                        }, 3000);
                    }
