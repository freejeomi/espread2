...
$_SESSION['last_screen'] = "supplier.php";
?>
...
//					rolenames = rolenames.replace(/#/g, ";");						
				...
				//data : jqgrid_data,					 
				url: "ajax/setup/supplier_grid_get.php",
				datatype: "json",
				mtype: "GET",
				height : 'auto',
				colNames : ['Actions', 'Id', 'Supplier Name', 'Supplier Email', 'Supplier Phone','Supplier Address', 'Supplier City','Supplier State','Supplier Country', 'Date registered','Username'],
				colModel : [
					{
					name : 'act',
					index : 'act',
					...
					index : 'supplier_name',
					editable : true,
					editrules:{"text":true,"required":true}
				}, {
					name : 'supplier_email',
				...
				name : 'supplier_country',
					...
					editable : true,
					edittype:"select",
					editoptions:{dataUrl:"get_country.php",cacheUrlData:true}
				},
				{name : 'dateregistered',
					...
					editable : true,
					edittype:"select",
					editoptions:{dataUrl:"get_username.php",cacheUrlData:true}
				}],
				rowNum : 10,
				rowList : [10, 20, 30],
				pager : '#pjqgrid',
				...
				editurl : "ajax/setup/supplier_grid_set.php",
				caption : "Supplier",
				multiselect : true,
				autowidth : true,
