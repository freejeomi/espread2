...
////	//$responce[]= $row;
	...
	$responce->rows[$i]['cell']=array($row['suppliertrans_Id'], $row['payment_date'], $row['payment_time'], $row['ref'] ,$row['credit'],$row['debit'], $row['payment_type'], $row['transaction_type'], $row['remark'], $row['username']);
	$i++;
}
