...
////	//$responce[]= $row;
    $responce->rows[$i]['id']=$row['store_id'];
    $responce->rows[$i]['cell']=array($row['store_id'], $row['store_id'], $row['store_name'],$row['location'], $row['useinreorder'],$row['includeingeneral'],$row['indicatemainstore'],$row['retailoutlet']);
    $i++;
}
