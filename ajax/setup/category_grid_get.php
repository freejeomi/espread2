...
//if($start <0) $start = 0;
//$sql = "SELECT * FROM category ORDER BY $sidx $sord LIMIT $start , $limit";
...
////	//$responce[]= $row;
    ...
    $responce->rows[$i]['cell']=array($row['category_id'], $row['category_id'],$row['category_name'], $row['cat_code']);
    $i++;
}
