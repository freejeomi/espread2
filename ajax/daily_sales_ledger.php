...
$_SESSION['last_screen'] = "daily_sales_ledger.php";
?>
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="modal-body">
                                <p class="alert alert-danger" id="alert_fail">Are you sure you want to remove cashier assigned to this invoice?</p>
                            </div>
            ...
            jQuery("#jqgrid").jqGrid({
               ...
               // loadonce:true,
                ...
                gridComplete : function() {
                    ...
                    //alert(rolenames);
//                    function cashierUnassign(r_id) {
//                        var id = r_id;
//                        var alertmessage= "<div>Do u want to unassign cashier?</div></br><button>No</button><button>Yes</button>";
//                        alert(alertmessage);
//                    }
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        if (status_name== "CLOSED"){
                            //$.post('invoice.php', {ledger_invoice_num: cl}, function (response) {
