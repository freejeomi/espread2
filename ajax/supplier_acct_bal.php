...
$_SESSION['last_screen'] = "supplier_acct_bal.php";
?>
<!--
	...
	var pagefunction = function() {
		...
		function run_jqgrid_function() {
			...
			//	var jqgrid_data = JSON.parse(data);			
				...
				mtype: "GET",
				height : 'auto',				
				colNames : ['Supplier Id', 'Name of Supplier', 'Current Balance', 'Account Statement', 'Payment'],
				colModel : [
				{					
					name : 'supplier_Id',
					index : 'supplier_Id',
				...
				},
				{
					...
					sortable : false,
					formatter: 'showlink',
					formatoptions: {baseLinkUrl: "#ajax/", showAction: "supplier_acct_detail.php", idName: "sup_Id" }
				},
				{
					name : 'act2',
					index : 'act2',
					sortable : false,
					formatter: 'showlink',
					formatoptions: {baseLinkUrl: "#ajax/", showAction: "update_supplier_acct.php", idName: "sup_Id" }
				}				
				],
				rowNum : 10,
				rowList : [10, 20, 30],
				...
				gridComplete : function() {
					...
					for (var i = 0; i < ids.length; i++) {
						...
						mp= "<p class='btn btn-sm btn-success'>Update Account</p>";
