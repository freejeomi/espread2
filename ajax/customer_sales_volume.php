...
$_SESSION['last_screen'] = "customer_sales_volume.php";
?>
<!--widget grid-->
            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form id="sales_allocation" method="POST" autocomplete="off">
                            <div class="row">
...
//var stock_id;
    ...
    $(document).ready(function () {
        $('#sales_allocation').submit(function (event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'ajax/customer_account/cust_sales_vol_post.php',
                data: formData,
                dataType: 'json',
                encode: true
            }).done(function (data) {
                if (!data.success) {
                    ...
                    window.open ( 'customer_sales_vol_list.php?start_date='+ formData.start_date +'&end_date='+ formData.end_date + '&tab=' + table_check);
                }
            });
