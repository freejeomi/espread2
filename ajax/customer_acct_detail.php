...
$_SESSION['last_screen'] = "customer_acct_detail.php";
?>
<!--
					...
					<div class="widget-body">						
						<div class="row container-fluid">
							<section class="col-md-4 col-sm-4 col-lg-4 col-xs-12 well">
								<div class="row">
									<span class="col-md-6">Name: <b><?php echo $cus_name;?></b></span>
							...
							<section class="col-md-5 col-sm-5 col-lg-5 col-xs-12 well">
								...
								<div class="row">
									...
									<span class="col-md-4">Total Debit: <b><?php echo number_format($debit, 2);?></b></span>
									
									<span class="col-md-4">Total Credit: <b><?php echo number_format($credit, 2) ;?></b></span>
<!--									<span class="col-md-1"></span>-->
									
									<span class="col-md-4">Balance: <b><?php echo number_format($closingbal, 2) ;?></b></span>
...
<div class-='pull_right'>
		<a class='btn btn-sm btn-primary' href="<?php echo APP_URL;?>/customer_acct_detail_print.php?cus_Id=<?php echo $cus_id; ?>" target="_blank">Print Account Statement</a>
	</div>	
	<!-- end row -->
	...
	var pagefunction = function() {
		...
		function run_jqgrid_function() {
			...
			//	var jqgrid_data = JSON.parse(data);			
				...
				//data : jqgrid_data,					 
				url: "ajax/customer_account/customer_acct_detail_get.php?cus_Id=<?php echo $_GET['cus_Id'];?>",
				datatype: "json",
				mtype: "GET",
				height : 'auto',
				colNames : ['Transaction ID', 'Date of Transaction', 'Time of Transaction', 'Reference', 'Credit', 'Debit', 'Payment Type', 'Remark', 'User Id'],
				colModel : [
				{					
					name : 'transaction_Id',
