...
$_SESSION['last_screen'] = "stock_valuation.php";
...
<section id="widget-grid" class="">
    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <a class="pull-right text-primary" href="stock_valuation.php" target="_blank">view printable version</a>
        </article>
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    var pagefunction = function() {
        ...
        function run_jqgrid_function() {
            ...
            jQuery("#jqgrid").jqGrid({
                //data : jqgrid_data,
                url: "ajax/stock_inventory/stock_valuation_get.php",
                datatype: "json",
                mtype: "GET",
                height : 'auto',
...
//                        formatter:'number',
                ...
                loadonce:true,//all searching and filtering are done locally
                ignoreCase: true,
                ...
                gridComplete: function () {
                    $('#refresh_jqgrid').click(function () {
                        jQuery('#jqgrid').jqGrid('setGridParam',{url:"ajax/stock_inventory/stock_valuation_get.php", page: 1,datatype: "json"}).trigger("reloadGrid");
                    });
                },
...
//                },
            ...
            $('#jqgrid').jqGrid('navGrid',"#pjqgrid",
                ...
                {caption: "Search Stock Valuation...",
