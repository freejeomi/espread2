...
////	//$responce[]= $row;
	...
	$responce->rows[$i]['cell']=array($row['transaction_Id'], $row['date'], $row['time'], $row['invoice_num'] ,number_format($row['credit'], 2) ,number_format($row['debit'], 2) , $row['payment_type'], $row['remark'], $row['username']);
	$i++;
}
