...
// Write the SQL Query
$grid->SelectCommand = 'SELECT * FROM category';
// Set the table to where you add the data
$grid->table = 'category';
$grid->setPrimaryKeyId('category_id');
...
$grid->setColProperty('category_id', array("editrules"=>array("required"=>true),"label"=>"ID","editable"=>false));
$grid->setColProperty('category_name', array("label"=>"Category Name","editrules"=>array("text"=>true,"required"=>true)));
