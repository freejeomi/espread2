...
// Write the SQL Query
$grid->SelectCommand = 'SELECT * FROM cashier';
// Set the table to where you add the data
$grid->table = 'cashier';
$grid->setPrimaryKeyId('cashier_id');
...
$grid->setColProperty('cashier_id', array("editrules"=>array("required"=>true),"label"=>"Cashier ID","editable"=>false));
$grid->setColProperty('cashier_name', array("label"=>"Cashier Name"));
